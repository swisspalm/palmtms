...
export default function InstitutionUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setNumber_accounts(cleanValues.number_accounts);
    setErrors({});
  };
  const [institutionRecord, setInstitutionRecord] = React.useState(institution);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Institution, idProp)
        : institution;
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Institution.copyOf(institutionRecord, (updated) => {
